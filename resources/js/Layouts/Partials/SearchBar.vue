...
const props = defineProps({
    ...
    placeholder: { type: String, default: 'Search by ' },
    ...
    <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
        ...
        <div class="flex items-center w-full sm:justify-end">
            <div class="flex pl-2 space-x-1">
                <!-- Settings -->
                <a href="#" @click.prevent="emitAction('settings')"
                ...
                <!-- Trash / Clear -->
                <a href="#"
                    @click.prevent="emitAction('deleteSelected')"
                    class="inline-flex justify-center p-1 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100
                        dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
                ...
                <!-- Info -->
                <a href="#" @click.prevent="emitAction('info')"
                    class="inline-flex justify-center p-1 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100
                        dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd"
                ...
                <!-- Menu -->
                <a href="#" @click.prevent="emitAction('menu')"
                    class="inline-flex justify-center p-1 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100
                        dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
