...
import AdminNotificationsDropdown from '@/Components/Admin/Notifications/AdminNotificationsDropdown.vue'
...
onMounted(() => {
    ...
    initAdminNotifications({ canListen: true })
                ...
                <template #trigger>
                    ...
                    >
                        ...
                        <span
                            ...
                            class="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold leading-none text-white bg-red-600 border-2 border-white rounded-full -top-2 -end-2 z-20 dark:border-gray-800"
                        >
                            {{ unreadNotifications }}
                        </span>
                    </button>
