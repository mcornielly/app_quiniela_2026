...
class SyncTournamentStadiumsFromApiFootball extends Command
{
    ...
    private function worldCup2026VenueMap(): array
    {
        return [
            ...
            'guadalajara' => ['name' => 'Estadio Akron', 'country' => 'Mexico', 'city' => 'Guadalajara'],
            'monterrey' => ['name' => 'Estadio BBVA', 'country' => 'Mexico', 'city' => 'Monterrey'],
            'toronto' => ['id' => 312, 'name' => 'BMO Field', 'country' => 'Canada', 'city' => 'Toronto'],
            'vancouver' => ['id' => 19445, 'name' => 'BC Place', 'country' => 'Canada', 'city' => 'Vancouver'],
            'seattle' => ['name' => 'Lumen Field', 'country' => 'United States', 'city' => 'Seattle'],
            'san francisco bay area' => ['name' => 'Levi S Stadium', 'country' => 'United States', 'city' => 'Santa Clara'],
            'los angeles' => ['name' => 'SoFi Stadium', 'country' => 'United States', 'city' => 'Inglewood'],
            'kansas city' => ['name' => 'Arrowhead Stadium', 'country' => 'United States', 'city' => 'Kansas City'],
            'dallas' => ['name' => 'AT T Stadium', 'country' => 'United States', 'city' => 'Arlington'],
            'houston' => ['name' => 'NRG Stadium', 'country' => 'United States', 'city' => 'Houston'],
            'atlanta' => ['name' => 'Mercedes Benz Stadium', 'country' => 'United States', 'city' => 'Atlanta'],
            'miami' => ['name' => 'Hard Rock Stadium', 'country' => 'United States', 'city' => 'Miami Gardens'],
            'boston' => ['name' => 'Gillette Stadium', 'country' => 'United States', 'city' => 'Foxborough'],
            'philadelphia' => ['name' => 'Lincoln Financial Field', 'country' => 'United States', 'city' => 'Philadelphia'],
            'new york new jersey' => ['name' => 'MetLife Stadium', 'country' => 'United States', 'city' => 'East Rutherford'],
        ];
    }
}
